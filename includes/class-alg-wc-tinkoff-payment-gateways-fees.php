<?php
/**
 * Tinkoff Payment Gateways for WooCommerce - Fees Class
 *
 * @version 1.6.0
 * @since   1.6.0
...
if ( ! class_exists( 'Alg_WC_Tinkoff_Payment_Gateways_Fees' ) ) :

	/**
	 * Fees Class.
	 */
	class Alg_WC_Tinkoff_Payment_Gateways_Fees {
		...
		public function scripts() {
			wp_enqueue_script(
				'alg-wc-tinkoff-payment-gateways',
				alg_wc_tinkoff_payment_gateways()->plugin_url() . '/includes/js/alg-wc-tinkoff-payment-gateways.js',
				array( 'jquery' ),
				alg_wc_tinkoff_payment_gateways()->version,
				true
			);
		}
...
return new Alg_WC_Tinkoff_Payment_Gateways_Fees();
